                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Item Based Sale Report</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>
                                                    Customize, generate and export item based sales reports in spreadsheet(.csv, .xlsx, .xls) or pdf format. <br>
                                ...
                                <div class="row">
                                    ...
                                    if (isset($_POST['get_sale_reports'])) {
                                        ...
                                        include('../helpers/reports/item_based_sales.php');
                                    } ?>
                                </div>
                            </div>
                        </div>
