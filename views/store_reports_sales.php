                                ...
                                <div class="nk-block-between-md g-3">
                                    <div class="nk-block-head-content">
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h4 class="nk-block-title fw-normal">Sales Reports</h4>
                                                <p>
                                                    Customize, generate and export sales reports in spreadsheet(.csv, .xlsx, .xls) or pdf format. <br>
                                                    You can either chose between simplified reports and composite reports. </p>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                if (isset($_POST['get_sale_reports'])) {
                                    ...
                                    if ($sale_report_type == 'Summarized Report') {
                                        ...
                                        include('../helpers/reports/store_summarized_sales.php');
                                    } else if ($sale_report_type == 'Composite Report') {
                                        /* Show Composite Report */
                                        include('../helpers/reports/store_composite_sales.php');
                                    }
                                } ?>
                            </div>
                        </div><!-- .card -->
