...
while ($stores = $res->fetch_object()) {
                ...
                <html>
                    ...
                    <body style="margin:1px;">
                        ...
                        <div class="list_header" align="center">
                            ...
                            <h5 style="font-size:14pt">Item Based Sale Reports From ' . date('M d Y', strtotime($start)) . ' To ' . date('M d Y', strtotime($end)) . ' </h5>
                        </div>
                        <table border="1" cellspacing="0" width="98%" style="font-size:9pt">
                            <thead>
                                <tr>
                                    <th style="width:100%">Item Details</th>
                                    <th style="width:100%">Total Quantity Sold</th>
                            ...
                            <tbody>
                                ...
                                while ($sales = $res->fetch_object()) {
                                    $cumulative_income += $sales->total_amount;
                                    ...
                                    '
                                        <tr>
                                            ...
                                            <td>' . "Ksh " . number_format($sales->total_amount, 2) . '</td>
                                        </tr>
                                    ';
                                }
                                    $html .= '
    ...
    $dompdf->render();
    $dompdf->stream('Item Sales Report From ' . $start . ' To ' . $end, array("Attachment" => 1));
