                    ...
                    <div class="nk-content-inner">
                        <div class="nk-content-body">
                                ...
                                <div class="nk-block-between-md g-3">
                                    <div class="nk-block-head-content">
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h4 class="nk-block-title fw-normal">Income Statements</h4>
                                                <p>
                                                    Customize, generate and export income statements reports in pdf format.
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <form method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="text-right">
                                                        <button name="GetIncomeStatements" class="btn btn-primary" type="submit">
                            ...
                            if (isset($_POST['GetExpensesReports'])) {
                                ...
                                $store = $_GET['view'];
                                include('../helpers/reports/income_statements.php');
                            } ?>
                        </div><!-- .card -->
                    </div><!-- .col -->
                </div><!-- .row -->
