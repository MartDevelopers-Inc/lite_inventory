<nav class="pcoded-navbar">
    ...
    <div class="pcoded-inner-navbar main-menu">
                ...
                <div class="main-menu-content">
                    <ul>
                        <li class="more-details">
                            <a href="manager_dashboard_profile"><i class="fas fa-user-cog"></i>Profile Settings</a>
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="">
                <a href="manager_dashboard" class="waves-effect waves-dark">
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="">
                <a href="manager_dashboard_stores" class="waves-effect waves-dark">
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="">
                <a href="manager_dashboard_products" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="fas fa-boxes"></i><b>FC</b></span>
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="">
                <a href="manager_dashboard_manage_stocks" class="waves-effect waves-dark">
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="">
                <a href="manager_dashboard_staffs" class="waves-effect waves-dark">
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="">
                <a href="manager_dashboard_sales_reports" class="waves-effect waves-dark">
            ...
            <li class="">
                <a href="manager_dashboard_inventory_report" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="fas fa-file-chart-line"></i><b>C</b></span>
            ...
            <!-- <li class="">
                <a href="manager_dashboard_customer_purchases_reports" class="waves-effect waves-dark">
             ...
             <li class="">
                <a href="manager_dashboard_staffs_perfomances_reports" class="waves-effect waves-dark">
