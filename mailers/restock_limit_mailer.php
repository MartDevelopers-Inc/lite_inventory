...
/* Update This SQL Add Store Session When Selling */
$ret = "SELECT * FROM `mailer_settings` JOIN store_settings WHERE store_status = 'active'  ";
...
while ($mailer = $res->fetch_object()) {
    ...
    $mail->addAddress($mailer->store_email);
    ...
    $mail->Subject = 'Restock Item Notification';
                    ...
                    <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                        ...
                        <tr>
                            <td style="text-align:center;">
                              <a href="https://hydrodrillsolutions.com/wp-content/uploads/sites/436/2021/02/hydrodrill-logo-500x107.jpg"  target="_blank">
                                <img width="200" src="https://hydrodrillsolutions.com/wp-content/uploads/sites/436/2021/02/hydrodrill-logo-500x107.jpg"  alt="Logo">
                              </a>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:"Rubik",sans-serif;">' . $product_details . ' Restock Limit Notification</h1>
                                            <span
                                                style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                Hello ' . $mailer->store_name . ', <br>
                                                This store is receiving this notification because its running low on
                                                <b>' . $product_details . ' </b>.<br>
                                                Current available quantity is : ' . $product_qty . ' items.                                                 
                                            </p>
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                               <br>
                                               Kind Regards<br>
                                               <b>Hydrodrill IT Team </b> <br>
                                               <i>
                        ...
                        <tr>
                            <td style="text-align:center;">
                                <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; ' . date('Y') . ' <strong>. A <a href="https://devlan.co.ke"> DevLan Solutions LTD </a> Production</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td style="height:80px;">&nbsp;</td>
