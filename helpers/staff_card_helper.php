...
$request = [
    ...
    'redirect_url' =>'http://pos.devlan.co.ke/views/staff_dashboard_payment_response?receipt_number=' . $sale_receipt_no . '&name=' . $sale_customer_name . '&phone=' . $sale_customer_phoneno . '',
    'customer' => [
